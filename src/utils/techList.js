export const techList = [
  ...
  {
    name: "Shadcn",
    description: "Minimal UI library",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
